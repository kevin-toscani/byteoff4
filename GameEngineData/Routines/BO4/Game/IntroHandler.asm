...
tblIntroText:
    .db INTRO_PAUSE, $80
    .db INTRO_SCREEN_ON, INTRO_PAUSE, $28

    .db INTRO_BIP, INTRO_BIP, INTRO_BIP
    .db INTRO_PAUSE, $20, INTRO_SPACE
    .db LTTR+8, LTTR+5, LTTR+12, LTTR+12, LTTR+15, L_QMARK
    .db INTRO_PAUSE, $20, INTRO_NL
    .db LTTR+23, LTTR+8, LTTR+15, L_APOS, INTRO_EYE+3, LTTR+19, INTRO_EYE+1, INTRO_SPACE
    .db LTTR+20, LTTR+8, LTTR+5, LTTR+18, LTTR+5, L_QMARK
    .db INTRO_PAUSE, $20, INTRO_CLEAR
    .db INTRO_EYE+3, INTRO_SPACE, INTRO_EYE+1
    .db INTRO_PAUSE, $16, INTRO_CLEAR

    .db INTRO_EYE+4
    .db LTTR+8, LTTR+9, INTRO_SPACE, LTTR+20, LTTR+8, LTTR+5, LTTR+18, LTTR+5
    .db L_COMMA, INTRO_SPACE, INTRO_PAUSE, $0A
    .db LTTR+19, LTTR+16, LTTR+1, LTTR+3, LTTR+5, INTRO_NL
    .db LTTR+20, LTTR+18, LTTR+1, LTTR+22, LTTR+5, LTTR+12, LTTR+5, LTTR+18
    .db L_EXCL, INTRO_SPACE, INTRO_PAUSE, $20
...
tblIntroEyeX:   .db $00, $22, $22, $22, $22
tblIntroEyeY:   .db $00, $5C, $5C, $5C, $5C
tblIntroEyeChr: .db $00, $B0, $B0, $B2, $B4
